...
bool operator==(const ::hector_elevation_msgs::ElevationMapMetaData_<ContainerAllocator1> & lhs, const ::hector_elevation_msgs::ElevationMapMetaData_<ContainerAllocator2> & rhs)
{
  return lhs.map_load_time == rhs.map_load_time &&
    lhs.resolution_xy == rhs.resolution_xy &&
    lhs.resolution_z == rhs.resolution_z &&
    lhs.min_elevation == rhs.min_elevation &&
    lhs.max_elevation == rhs.max_elevation &&
    lhs.zero_elevation == rhs.zero_elevation &&
    lhs.width == rhs.width &&
